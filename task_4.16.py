...
class Soldat:
    ...
    def __init__(self, hero_1, hero_2):
        '''Юниты распределяемые по командам'''
        self.units_level_1 = list(range(1, 41))
        self.units_level_2 = list(range(1, 101))
        self.units_level_3 = list(range(1, 201))
...
round1 = Soldat('AXE', 'HEX')
round1.round_1()
round1.round_2()
round1.round_3()
# print(round1.team_list_1)
